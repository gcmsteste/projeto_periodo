...
public class ServletAluno extends HttpServlet {
    ...
    private static final String ATRIBUTO_MONITORES = "listaMonitores";
    /**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List<Monitor> listaMonitorias = new ArrayList<Monitor>();
			listaMonitorias.add(monitor);
			request.setAttribute(ATRIBUTO_MONITORES, listaMonitorias);
