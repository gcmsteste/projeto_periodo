...
INSERT INTO PROJETO_PERIODO.PROFESSOR (PROFESSOR_NOME, PROFESSOR_SIAPE)
...
(SELECT PROFESSOR_ID FROM PROFESSOR WHERE PROFESSOR_NOME LIKE 'Roberto'),
...
VALUES( (SELECT DS.ALUNO_ID FROM DISCIPLINA_ALUNO AS DS, ALUNO AS A 
      ...
      (SELECT DA.DISCIPLINA_ID FROM DISCIPLINA_ALUNO AS DA, DISCIPLINA AS D
       WHERE D.DISCIPLINA_DS LIKE 'Padrões de Projeto') );
