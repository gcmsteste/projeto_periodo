...
VALUES ('SUPERIOR', 'AnÃ¡lise de Sistemas');
...
VALUES( (SELECT USUARIO_ID  FROM USUARIO
        ...
        (SELECT CURSO_ID FROM CURSO
         WHERE CURSO_DS LIKE 'AnÃ¡lise de Sistemas') );

INSERT INTO PROJETO_PERIODO.DISCIPLINA (DISCIPLINA_DS, CURSO_ID)
SELECT 'PadrÃµes de Projeto', (SELECT CURSO_ID FROM CURSO WHERE CURSO_DS LIKE 'AnÃ¡lise de Sistemas') 
FROM DUAL
WHERE NOT EXISTS (SELECT * FROM DISCIPLINA
WHERE DISCIPLINA_DS = 'PadrÃµes de Projeto');
...
VALUES ( (SELECT ALUNO_ID FROM ALUNO
		 ...
		 ( SELECT DISCIPLINA_ID FROM DISCIPLINA
		   WHERE DISCIPLINA_DS LIKE 'PadrÃµes de Projeto') );
...
VALUES('DireÃ§Ã£o de Ensino', 'DEN');